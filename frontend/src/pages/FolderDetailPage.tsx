...
export default function FolderDetailPage({ folderName, conversations, onRestore }: Props) {
        ...
        <div className="w-full max-w-[560px] flex flex-col">
          ...
          <div style={cardStyle}>
            {conversations.length === 0 ? (
              ...
              >
                No conversations in this folder. Use “Add to folder” in the top bar while in a flow to add one.
              </div>
            ) : (
              <div>
                {conversations.map((c) => {
